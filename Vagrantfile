...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.define "soa2admin2" , primary: true do |soa2admin2|
    ...
    soa2admin2.vm.box = "centos-7-1708-x86_64"
    soa2admin2.vm.box_url = "https://dl.dropboxusercontent.com/s/7dr5ewj4mvohynu/centos-7-1708-x86_64.box"
...
#                                  '--parser future',
  ...
  config.vm.define "mft1admin" , primary: true do |mft1admin|
    ...
    mft1admin.vm.box = "centos-7-1708-x86_64"
    mft1admin.vm.box_url = "https://dl.dropboxusercontent.com/s/7dr5ewj4mvohynu/centos-7-1708-x86_64.box"
...
#                                  '--parser future',
  ...
  config.vm.define "soadb" , primary: true do |soadb|
    ...
    soadb.vm.box = "centos-7-1708-x86_64"
    soadb.vm.box_url = "https://dl.dropboxusercontent.com/s/7dr5ewj4mvohynu/centos-7-1708-x86_64.box"
